    ...
    public static void capture(DeltaTracker realDelta) {
        ...
        try {
            ...
            camState.projectionMatrix.set(new Matrix4f().perspective(
                    ...
                    0.05F, camState.depthFar, RenderSystem.getDevice().getDeviceInfo().isZZeroToOne()));
            ...
            ((GameRendererAccessor) gameRenderer).globalSettingsUniform().update(
                    feedWidth,
                    FEED_HEIGHT,
            ...
            var grs2 = gameRenderer.gameRenderState();
            ((GameRendererAccessor) gameRenderer).globalSettingsUniform().update(
