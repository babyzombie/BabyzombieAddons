...
public class KuudraConfig {
    ...
    public static class ArrowPoison {
        ...
        @Expose @ConfigOption(name = "config.babyzombieaddons.option.toxicArrowThreshold", desc = "config.babyzombieaddons.option.toxicArrowThreshold.desc") @ConfigEditorSlider(minValue = 0, maxValue = 32, minStep = 1)
    ...
    public static class Requeue {
        @Expose @ConfigEditorInfoText @ConfigOption(name = "config.babyzombieaddons.option.requeueKuudraNote", desc = "")
