...
public class FishingConfig {
    ...
    public static class WaterSeaCreatures {
        @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.waterHydra", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.waterHydra.desc") @ConfigEditorBoolean
        public boolean waterHydra = false;
        @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.abyssalMiner", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.abyssalMiner.desc") @ConfigEditorBoolean
        ...
        public static class Bayou {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.alligator", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.alligator.desc") @ConfigEditorBoolean
            public boolean alligator = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.titanoboa", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.titanoboa.desc") @ConfigEditorBoolean
            public boolean titanoboa = false;
        }

        public static class Galatea {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.theLochEmperor", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.theLochEmperor.desc") @ConfigEditorBoolean
            public boolean theLochEmperor = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.nessie", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.nessie.desc") @ConfigEditorBoolean
            public boolean nessie = false;
        }

        public static class Lotus {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.puddleJumper", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.puddleJumper.desc") @ConfigEditorBoolean
            public boolean puddleJumper = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.frogPrince", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.frogPrince.desc") @ConfigEditorBoolean
            public boolean frogPrince = false;
        }

        public static class Torrhus {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.silkbreeze", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.silkbreeze.desc") @ConfigEditorBoolean
            public boolean silkbreeze = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.giantIsopod", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.giantIsopod.desc") @ConfigEditorBoolean
            public boolean giantIsopod = false;
        }

        public static class WaterHotspot {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.blueRingedOctopus", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.blueRingedOctopus.desc") @ConfigEditorBoolean
            public boolean blueRingedOctopus = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.wikiTiki", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.wikiTiki.desc") @ConfigEditorBoolean
            public boolean wikiTiki = false;
        }

        public static class JerrysWorkshop {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.yeti", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.yeti.desc") @ConfigEditorBoolean
            public boolean yeti = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.reindrake", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.reindrake.desc") @ConfigEditorBoolean
            public boolean reindrake = false;
        }

        public static class SpookyFestival {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.phantomFisher", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.phantomFisher.desc") @ConfigEditorBoolean
            public boolean phantomFisher = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.grimReaper", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.grimReaper.desc") @ConfigEditorBoolean
            public boolean grimReaper = false;
        }

        public static class FishingFestival {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.greatWhiteShark", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.greatWhiteShark.desc") @ConfigEditorBoolean
            public boolean greatWhiteShark = false;
        }
    }

    public static class LavaSeaCreatures {
        @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.thunder", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.thunder.desc") @ConfigEditorBoolean
        public boolean thunder = false;
        @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.lordJawbus", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.lordJawbus.desc") @ConfigEditorBoolean
        public boolean lordJawbus = false;
        @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.plhlegblast", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.plhlegblast.desc") @ConfigEditorBoolean
        ...
        public static class LavaHotspot {
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.fieryScuttler", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.fieryScuttler.desc") @ConfigEditorBoolean
            public boolean fieryScuttler = false;
            @Expose @ConfigOption(name = "config.babyzombieaddons.option.rareSeaCreaturesExclude.ragnarok", desc = "config.babyzombieaddons.option.rareSeaCreaturesExclude.ragnarok.desc") @ConfigEditorBoolean
